"""Challenge storage: Firestore when configured, in-memory for dev.

Firestore layout: challenges/{code} with a members uid array (server-side
...
class FirestoreChallengeRepository:
    ...
    def _collection(self):
        ...
        return firestore.client().collection(_CHALLENGES)
...
_memory_repo = InMemoryChallengeRepository()
